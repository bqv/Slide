...
data class Post(
        @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "rowid") override val id: Int = -1,
        ...
        @ColumnInfo(name = "body_html") override val bodyHtml: String = "", // not always markdown, dupe?
    ...
    @Ignore lateinit var votes: Map<Account, PostVote>
