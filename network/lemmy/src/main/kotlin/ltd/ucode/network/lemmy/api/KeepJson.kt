...
object KeepJson {
    internal class ConverterFactoryWrapper(
        ...
        override fun responseBodyConverter(type: Type, annotations: Array<out Annotation>, retrofit: Retrofit): Converter<ResponseBody, *> {
            ...
            val responseBodyConverter =
                backingConverterFactory.responseBodyConverter(type, annotations, retrofit)
        ...
        companion object {
            fun Converter.Factory.keepJson(): Converter.Factory {
                return ConverterFactoryWrapper(this)
            }

            fun ConverterFactoryWrapper.wrap(factory: Converter.Factory): Converter.Factory {
                return ConverterFactoryWrapper(factory)
            }
        }
    }
}
